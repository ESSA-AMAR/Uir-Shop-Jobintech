  ...
  return (
    <div>
      <div className="py-5  flex justify-between  ">
        <h1 className="text-[#183761] font-semibold text-[25px]">
          Populare Products
        </h1>
        <Link
          to="/product/textile"
          className="flex  items-center gap-2 text-[#183761] font-semibold  text-[25px]"
        >
          See all <img src={flech} alt="" className="w-[50px]" />
        </Link>
      </div>
